...
class MyMotifs:
    ...
    def doCounts(self):
        #cria uma matriz so com 0
        #preencher a matriz com a contagem
    ...
    def createPWM(self):
        #para cada uma das posicoes da matriz
    ...
    def consensus(self):
        #identificar qual o simbolo do alfabeto com maior ocorrencia
        res = ""
        for j in range(self.size):
    ...
    def probAllPositions(self, seq):
        #iterar a sequancia sobre todas as posicoes iniciais possiveis
        res = []
    ...
    def mostProbableSeq(self, seq):
        #percorrer a sequencia e guardar a maior probabilidade encontrada
        maximo = -1.0
        maxind = -1
